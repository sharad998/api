...
class UseCaseModule {
    ...
    @Provides
    fun provideGetTvShowUseCase(tvShowRepository: TvShowRepository)
    :GetTvShowsUseCase{
    ...
    @Provides
    fun provideUpdateTvShowUseCase(tvShowRepository: TvShowRepository)
    ...
    @Provides
    fun provideGetArtistUseCase(artistRepository: ArtistRepository)
            : GetArtistsUseCase {
    ...
    @Provides
    fun provideUpdateArtistUseCase(artistRepository: ArtistRepository)
