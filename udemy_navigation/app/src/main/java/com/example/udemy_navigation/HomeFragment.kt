package com.example.udemy_navigation
...
import com.example.udemy_navigation.databinding.FragmentHomeBinding
    ...
    override fun onCreateView(
        ...
        binding.button.setOnClickListener(View.OnClickListener {
            if(!TextUtils.isEmpty(binding.editText.text)) {
                val bundle: Bundle = bundleOf("use_input" to binding.editText.text.toString())
